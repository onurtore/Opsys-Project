...
extern unsigned long volatile jiffies; //CSE OPSYS PROJECT
 ...
 */
	int ticket_number; //CSE OPSYS PROJECT
	unsigned long last_run; //CSE OPSYS PROJECT
	int used;  //CSE OPSYS PROJECT
	long counter;
	long nice;
