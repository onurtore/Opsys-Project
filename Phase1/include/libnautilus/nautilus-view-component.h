...
#define _defined_POA_Nautilus_ViewFrame 1
   typedef struct
   {
      ...
      void (*go_back) (PortableServer_Servant _servant,
		       CORBA_Environment * ev);
      void (*close_window) (PortableServer_Servant _servant,
			    CORBA_Environment * ev);
...
/** skel prototypes **/
   void _ORBIT_skel_small_Nautilus_View_load_location(POA_Nautilus_View *
						      _ORBIT_servant,
						      ...
						      (PortableServer_Servant
						       ...
						       CORBA_Environment *
						       ev));
   void _ORBIT_skel_small_Nautilus_View_stop_loading(POA_Nautilus_View *
						     _ORBIT_servant,
						     gpointer _ORBIT_retval,
						     gpointer * _ORBIT_args,
						     CORBA_Context ctx,
						     ...
						     (PortableServer_Servant
						      ...
						      ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_open_location_in_this_window
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       ...
       void (*_impl_open_location_in_this_window) (PortableServer_Servant
						   ...
						   CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_open_location_prefer_existing_window
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_open_location_prefer_existing_window)
       (PortableServer_Servant _servant, const CORBA_char * location,
	CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_open_location_force_new_window
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_open_location_force_new_window) (PortableServer_Servant
						     ...
						     CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_report_location_change
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_report_location_change) (PortableServer_Servant _servant,
					     ...
					     CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_report_redirect
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_report_redirect) (PortableServer_Servant _servant,
				      const CORBA_char * from_location,
				      const CORBA_char * to_location,
				      const Nautilus_URIList * selection,
				      const CORBA_char * title,
				      CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_report_selection_change
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_report_selection_change) (PortableServer_Servant _servant,
					      ...
					      CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_report_status
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_report_status) (PortableServer_Servant _servant,
				    const CORBA_char * status,
				    CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_report_load_underway
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_report_load_underway) (PortableServer_Servant _servant,
					   CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_report_load_progress
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_report_load_progress) (PortableServer_Servant _servant,
					   ...
					   CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_report_load_complete
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_report_load_complete) (PortableServer_Servant _servant,
					   CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_report_load_failed
      (POA_Nautilus_ViewFrame * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_report_load_failed) (PortableServer_Servant _servant,
					 CORBA_Environment * ev));
   void _ORBIT_skel_small_Nautilus_ViewFrame_set_title(POA_Nautilus_ViewFrame
						       * _ORBIT_servant,
						       gpointer _ORBIT_retval,
						       gpointer * _ORBIT_args,
						       CORBA_Context ctx,
							...
							CORBA_Environment *
							ev));
   void _ORBIT_skel_small_Nautilus_ViewFrame_go_back(POA_Nautilus_ViewFrame *
						     _ORBIT_servant,
						     gpointer _ORBIT_retval,
						     gpointer * _ORBIT_args,
						     CORBA_Context ctx,
						     ...
						     (PortableServer_Servant
						      ...
						      ev));
   void
      _ORBIT_skel_small_Nautilus_ViewFrame_close_window(POA_Nautilus_ViewFrame
							* _ORBIT_servant,
							gpointer
							_ORBIT_retval,
							gpointer *
...
#define Nautilus_ViewFrame_queryInterface Bonobo_Unknown_queryInterface
   ...
   void
      ...
      (Nautilus_ViewFrame _obj, const CORBA_char * location,
       CORBA_Environment * ev);
   ...
   void Nautilus_ViewFrame_go_back(Nautilus_ViewFrame _obj,
				   CORBA_Environment * ev);
   void Nautilus_ViewFrame_close_window(Nautilus_ViewFrame _obj,
					CORBA_Environment * ev);
...
#define Nautilus_ViewFrame_IMETHODS_LEN 14
#ifdef ORBIT_IDL_C_IMODULE_nautilus_view_component
   static
#else
   extern
#endif
   ORBit_IMethod
      Nautilus_ViewFrame__imethods[Nautilus_ViewFrame_IMETHODS_LEN];
#ifdef __cplusplus
}
#endif				/* __cplusplus */
