...
#define _defined_POA_Nautilus_Undo_Transaction 1
   typedef struct
   {
      ...
      Nautilus_Undo_MenuItem *(*_get_redo_menu_item) (PortableServer_Servant
						      _servant,
						      CORBA_Environment * ev);
       CORBA_string(*_get_operation_name) (PortableServer_Servant _servant,
					   CORBA_Environment * ev);
...
/** skel prototypes **/
   void
      _ORBIT_skel_small_Nautilus_Undo_Transaction__get_undo_menu_item
      (POA_Nautilus_Undo_Transaction * _ORBIT_servant, gpointer _ORBIT_retval,
       ...
       (*_impl__get_undo_menu_item) (PortableServer_Servant _servant,
				     CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_Undo_Transaction__get_redo_menu_item
      (POA_Nautilus_Undo_Transaction * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       Nautilus_Undo_MenuItem *
       (*_impl__get_redo_menu_item) (PortableServer_Servant _servant,
				     CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_Undo_Transaction__get_operation_name
      (POA_Nautilus_Undo_Transaction * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       CORBA_string(*_impl__get_operation_name) (PortableServer_Servant
						 _servant,
						 CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_Undo_Transaction_undo
      (POA_Nautilus_Undo_Transaction * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
       void (*_impl_undo) (PortableServer_Servant _servant,
			   CORBA_Environment * ev));
   void
      _ORBIT_skel_small_Nautilus_Undo_Manager_append(POA_Nautilus_Undo_Manager
						     * _ORBIT_servant,
						     ...
						     (PortableServer_Servant
						      ...
						      ev));
   void
      _ORBIT_skel_small_Nautilus_Undo_Manager_forget(POA_Nautilus_Undo_Manager
						     * _ORBIT_servant,
						     gpointer _ORBIT_retval,
						     gpointer * _ORBIT_args,
						     CORBA_Context ctx,
						     ...
						     (PortableServer_Servant
						      ...
						      CORBA_Environment *
						      ev));
   void _ORBIT_skel_small_Nautilus_Undo_Manager_undo(POA_Nautilus_Undo_Manager
						     * _ORBIT_servant,
						     gpointer _ORBIT_retval,
						     gpointer * _ORBIT_args,
						     CORBA_Context ctx,
						     ...
						     (PortableServer_Servant
						      ...
						      ev));
   void
      _ORBIT_skel_small_Nautilus_Undo_Context__get_undo_manager
      (POA_Nautilus_Undo_Context * _ORBIT_servant, gpointer _ORBIT_retval,
       gpointer * _ORBIT_args, CORBA_Context ctx, CORBA_Environment * ev,
...
#endif
   ORBit_IMethod
      Nautilus_Undo_Transaction__imethods
      [Nautilus_Undo_Transaction_IMETHODS_LEN];
#ifdef ORBIT_IDL_C_IMODULE_nautilus_distributed_undo
   static
#else
   extern
...
#endif
   ORBit_IMethod
      Nautilus_Undo_Manager__imethods[Nautilus_Undo_Manager_IMETHODS_LEN];
#ifdef ORBIT_IDL_C_IMODULE_nautilus_distributed_undo
   static
#else
   extern
...
#endif
   ORBit_IMethod
      Nautilus_Undo_Context__imethods[Nautilus_Undo_Context_IMETHODS_LEN];
#ifdef __cplusplus
}
#endif				/* __cplusplus */
